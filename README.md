...
You can find the executable **download** [**here**](https://github.com/David-Ernst/WaveGrid/releases/tag/v2.01).
...
- Press **r** to **reset** the simulations time
...
**Please note for the particle field that x1 ∈ ℝ≥0 and x2 ∈ ℝ≥0.
